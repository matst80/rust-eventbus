...
/// Orchestrates a single projection by subscribing to the EventBus, catching up
/// from the EventStore, and sequentially processing real-time events in a standalone task.
pub struct ProjectionActor<E: EventPayload, S, P, SS, ES> {
    bus: EventBus<E>,
    event_store: Arc<ES>,
    projection: Arc<P>,
...
impl<E, S, P, SS, ES> ProjectionActor<E, S, P, SS, ES>
where
    E: EventPayload,
